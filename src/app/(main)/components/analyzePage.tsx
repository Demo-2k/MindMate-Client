...
export const AnalyzePage =({ data }: { data: any}) => {
   ...
   console.log("llllllllllll", emotion);
        ...
        <div className="max-w-md mx-auto space-y-6 pt-50">
            <div className="flex flex-col gap-5">
                ...
                <div className="w-full max-w-md bg-white/60 backdrop-blur-xl rounded-2xl shadow-xl p-6">
                    ...
                    <p className="leading-relaxed font-medium text-center">{data?.horoscope}... </p>
                </div>
                <div className="w-full max-w-md bg-white/60 backdrop-blur-xl rounded-2xl shadow-xl p-6">
                    <div className="flex items-center gap-3 mb-4">
                    ...
                    <p className="text-xl font-bold leading-relaxed relative">{data?.message}...</p>
                </div>
            </div>
        </div>
    )
