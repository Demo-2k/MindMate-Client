...
import { DoneBreathExercise } from "../avatar/DoneAvatar";

// import { BreathingBtn } from "./breathingBtn";

type Phase = "inhale" | "hold" | "exhale";
const cycles = [
  { phase: "inhale" as Phase, duration: 4, label: "Амьсгалаа авах" },
  { phase: "hold" as Phase, duration: 4, label: "Барих" },
  { phase: "exhale" as Phase, duration: 6, label: "Амьсгалаа гаргах" },
];

export function ChatDialogBreath({
  open,
  setOpen,
  onDone,
}: {
  ...
  return (
    <div>
                    ...
                    <div className="absolute inset-[30px] rounded-full bg-white flex items-center justify-center">
                      ...
                      <motion.div
                        ...
                        transition={{
                          ...
                          ease:
                            currentPhase === "hold" ? "linear" : "easeInOut",
                        }}
                      >
      ...
      {done && <DoneBreathExercise onDone={onDone} />}
    </div>
  );
}
